...
b8 VulkanGraphicsPipelineCreate(
    ...
    // Viewport state
    VkPipelineViewportStateCreateInfo vieuwportState = {VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO};
    vieuwportState.viewportCount = 1;
    vieuwportState.pViewports = &viewport;
    vieuwportState.scissorCount = 1;
    vieuwportState.pScissors = &scissor;
    ...
    ZeroMemory(&colorBlendAttachmentState, sizeof(VkPipelineColorBlendAttachmentState));
    ...
    VkDynamicState dynamicState[dynamicStateCount] = {
    ...
    pipelineCreateInfo.pViewportState = &vieuwportState;
